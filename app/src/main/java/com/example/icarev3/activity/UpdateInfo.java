...
//        startActivity(backToProfileList);
    ...
    public void updateProfile(View view) {
        ...
        db.updateProfile(profileId, profileName, profileMobile, profileRelation,
                profileBirthDate, profileHeight, profileWeight, profileEmail,
                bloodGroupString, genderString, diabetesStatus, profileSugarLevel,
                highPressureStatus, profileBloodPressure, allergiesStatus,
                allergicalDescription, profileSugarLevelPrev, highPressureStatusPrev,
                profileWeightPrev, profileHeightPrev);
        finish();
