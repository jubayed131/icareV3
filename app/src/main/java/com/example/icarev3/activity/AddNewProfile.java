...
public class AddNewProfile extends AppCompatActivity {
    ...
    public void saveProfile(View view) {
        ...
        db.insertProfile(stringName, stringMobile, stringRelation, stringBirthDate,
                stringEmail, stringHeight, stringWeight, bloodGroupString, genderString,
                diabetesStatus, stringSugarLevel, highPressureStatus,
                stringBloodPressure, allergiesStatus, allergiDescription);
        Intent backToProfileList = new Intent(this, MainActivity.class);
        startActivity(backToProfileList);
        this.finish();
